...
module.exports = (elementValidated, ctx) => {
  ...
  switch(elementValidated){
    ...
    case 'story':
      return window.showErrorMessage('Could not link story. You input an invalid story ID.')
    case 'storyChange':
    ...
    case 'startedStory':
      console.log(67)
      window.showInformationMessage(`Successfully started story ${story}`).catch( console.log)
